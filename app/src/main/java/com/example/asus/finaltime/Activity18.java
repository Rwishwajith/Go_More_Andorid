...
public class Activity18 extends AppCompatActivity implements AdapterView.OnItemSelectedListener{
    ...
    EyeCatch user;
    private static final String TAG="Activity18";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ref=database.getReference("EyeCatch");
        user=new EyeCatch();
        ...
        mDisplayData.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view){
                ...
                DatePickerDialog dialog=new DatePickerDialog(Activity18.this,android.R.style.Theme_Holo_Light_Dialog_MinWidth,mDateSetListener,year,month,day);
        ...
        ArrayAdapter<CharSequence> adapter=ArrayAdapter.createFromResource(this,R.array.numbers4,android.R.layout.simple_spinner_item);
    ...
    public void btnInsert(View view){
        ref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                Toast.makeText(Activity18.this,"DATA INSERT...",Toast.LENGTH_LONG).show();

            }

            @Override
            public void onCancelled(@NonNull DatabaseError databaseError) {
                Toast.makeText(Activity18.this,"Not Insert",Toast.LENGTH_LONG).show();
            }
        });
    }
}

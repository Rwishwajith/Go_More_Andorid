...
public class Activity20 extends AppCompatActivity implements AdapterView.OnItemSelectedListener{
    ...
    Beach_Saffari user;
    private static final String TAG="Activity21";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ref=database.getReference("Beach_Saffari");
        user=new Beach_Saffari();
        ...
        mDisplayData.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view){
                ...
                DatePickerDialog dialog=new DatePickerDialog(Activity20.this,android.R.style.Theme_Holo_Light_Dialog_MinWidth,mDateSetListener,year,month,day);
        ...
        ArrayAdapter<CharSequence> adapter=ArrayAdapter.createFromResource(this,R.array.numbers6,android.R.layout.simple_spinner_item);
    ...
    public void btnInsert(View view){
        ref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                Toast.makeText(Activity20.this,"DATA INSERT...",Toast.LENGTH_LONG).show();

            }

            @Override
            public void onCancelled(@NonNull DatabaseError databaseError) {
                Toast.makeText(Activity20.this,"Not Insert",Toast.LENGTH_LONG).show();
            }
        });
    }
}

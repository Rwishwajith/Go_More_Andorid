...
public class Activity19 extends AppCompatActivity implements AdapterView.OnItemSelectedListener{
    ...
    Heritage user;
    private static final String TAG="Activity19";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ref=database.getReference("Heritage");
        user=new Heritage();
        ...
        mDisplayData.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view){
                ...
                DatePickerDialog dialog=new DatePickerDialog(Activity19.this,android.R.style.Theme_Holo_Light_Dialog_MinWidth,mDateSetListener,year,month,day);
        ...
        ArrayAdapter<CharSequence> adapter=ArrayAdapter.createFromResource(this,R.array.numbers5,android.R.layout.simple_spinner_item);
    ...
    public void btnInsert(View view){
        ref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                Toast.makeText(Activity19.this,"DATA INSERT...",Toast.LENGTH_LONG).show();

            }

            @Override
            public void onCancelled(@NonNull DatabaseError databaseError) {
                Toast.makeText(Activity19.this,"Not Insert",Toast.LENGTH_LONG).show();
            }
        });
    }
}
